    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          ...
          <div
            className="absolute z-40 inset-0 left-[3px] top-px right-[3px] bottom-px 
                rounded-[32px] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]"
          />
          <div
            className={cn(
              "absolute inset-0 top-px left-[1px] right-[1px] bottom-px rounded-[32px]",
              {
                    ...
                    {COLORS.map((color) => (
                      ...
                      >
                        <span
                          className={cn(
                            `bg-${color.tw}`,
                            "h-8 w-8 rounded-full border border-blac border-opacity-10"
                          )}
                        />
                      </RadioGroup.Option>
                    ))}
