    ...
    <div className="bg-slate-50">
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            >
              ...
              >
                Hô biến ảnh của bạn lên{" "}
                <span className="bg-amber-500 px-2 py-2 text-white rounded-[0.5rem]">
                  Ốp lưng
                </span>{" "}
                Độc đáo
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Lưu giữ kỷ niệm đẹp với ốp lưng{" "}
                <span className="font-semibold">độc nhất</span> của riêng bạn.
                Casela giúp bạn bảo vệ không chỉ chiếc điện thoại mà cả những ký
                ức quý giá.
              </p>
              <ul
              ...
              >
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p>
                    <span className="font-semibold">8386</span> khách hàng hài
                    lòng
                  </p>
                </div>
              </div>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              <Image
                ...
                width={208}
                height={208}
                className="absolute w-40 lg:w-52 left-56 -top-20 select-none h:block lg:hidden xl:block"
              />
              <Image
                src="/line.png"
                alt=""
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              <span className="relative px-2">
                ...
                absolute inset-x-0 -bottom-6 text-amber-500"
                />
              </span>
              nghĩ gì về Casela
            </h2>
          ...
          <div
            className="mx-auto grid max-w-2xl grid-cols-1 px-4 
          ...
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  &quot;Ốp lưng đẹp xuất sắc,{" "}
                  <span className="p-0.5 bg-slate-800 text-white rounded">
                    chất lượng in ấn tốt, bền bỉ
                  </span>
                  , giá cả phải chăng. Mình đã mua nhiều lần và rất hài lòng với
                  chất lượng sản phẩm. Đặc biệt là dịch vụ chăm sóc khách hàng
                  rất tốt.&quot;
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  &quot;Shop phục vụ rất{" "}
                  <span className="p-0.5 bg-slate-800 text-white rounded">
                    tận tình, tư vấn nhiệt tình
                  </span>
                  . Ốp lưng đẹp y hình, giao hàng nhanh.&quot;
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <Image
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                <span className="relative px-2">Tải ảnh của bạn lên </span>và
                nhận ngay ốp lưng{" "}
                <span className="bg-amber-500 text-white px-2 rounded-sm">
                  của riêng bạn
                </span>
              </h2>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              >
                <Image
                  src="/car.jpg"
                  alt="Original phone case picture"
                  fill
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              ...
              >
                Triển luôn nào <ArrowRight className="h-4 w-4 ml-1.5" />
              </Link>
            </div>
          </ul>
        </MaxWidthWrapper>
